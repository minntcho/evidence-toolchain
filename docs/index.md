...
4. [조사 루프 경계](investigation-loop-boundary.md)
5. [실험 manifest](experiment-manifest.md)
6. [실행 trace](experiment-run-trace.md)
7. [ExpectedBehavior oracle](expected-behavior-oracle.md)
8. [Experiment CLI runner](experiment-cli-runner.md)
9. [Synthetic Evidence Artifact Factory](synthetic-artifact-factory.md)
10. [증거 라우팅](evidence-routing.md)
11. [오케스트레이션 경계](orchestration-boundary.md)
12. [Capability 레지스트리](capability-registry.md)
13. [실패 모드](failure-modes.md)
14. [Adapter 경계](adapter-boundary.md)
15. [첨부 정규화](ingestion-normalization.md)
16. [합성 증거 테스트킷](synthetic-evidence.md)
